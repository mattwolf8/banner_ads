...
function tweens(){
    ...
    // Tweens
      ...
      // Scarfs
      TweenLite.to(tw_scarf,1.8, {right:38,autoAlpha:0.9,delay:0.25,ease:"easeOutElastic",force3D:true});
      // Colorfully Secure
      TweenLite.to(colorfully,1, {bottom:7, ease:'Elastic.easeOut',force3D:true});
      // img  | Fade
