...
function tweens(){
    ...
    // Tweens
      // Smart
      TweenLite.fromTo(tw_smart, 1.6, {left:-100, autoAlpha:1}, {left:32, autoAlpha:0.9,ease:"easeOutElastic",force3D:true});
      // Scarfs
      TweenLite.to(tw_scarf,1.8, {right:25,autoAlpha:0.9,delay:0.25,ease:"easeOutElastic",force3D:true});
      // Colorfully Secure
      //TweenLite.to(colorfully,1, {bottom:10, ease:'Elastic.easeOut',force3D:true});
      // img  | Fade
      TweenLite.to(photo,1, {opacity:1});
      TweenLite.to(photo1,1, {opacity:1});
      // colorfully fade
